...
urlpatterns = [
    ...
    path('bienestar/chat/', include('wellness.chat.urls')),  # Incluye las rutas del chat
    ...
    path('dashboard/', include('dashboard.urls')),  # Ruta para el dashboard general
]

from django.urls import include
urlpatterns += [
    path('dashboard/auth/', include('dashboard.urls')),
]
